    ...
    const mailOptions = {
      ...
      html: `
        ...
        <ul>
          ...
          <li><strong>Total:</strong> ${process.env.CURRENCY || "$"} ${
        booking.totalPrice
      }</li>
        </ul>
        <p>We look forward to welcoming you! If you need to make any changes, feel free to contact us.</p>
      `,
    };
